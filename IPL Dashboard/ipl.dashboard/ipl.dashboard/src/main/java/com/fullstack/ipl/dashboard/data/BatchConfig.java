...
public class BatchConfig {
	  ...
	  public JdbcBatchItemWriter<Match> writer(DataSource dataSource) {
		  /*
		   * Using the JPA @Entity we already get the table beforehand
		   * and jpa table columns convert camel case into _and small case eg: lastName=> last_name
		   * and values will be the same as the one in the Match class with : prepended
		   */
